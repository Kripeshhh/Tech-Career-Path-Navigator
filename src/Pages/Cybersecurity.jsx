...
import networkingImg from "../images/networking.webp";
import linuxImg from "../images/linux.png";
import encryptionImg from "../images/encryption.webp";
import hackingImg from "../images/ethical.webp";
...
export default function Cybersecurity() {
  ...
  const tools = [
    {
      name: "Networking",
      description: "Foundation of secure systems",
      guidance:
        "You'll need to understand TCP/IP, DNS, firewalls, and network protocols to secure infrastructure. Mastering network security concepts is fundamental for cybersecurity professionals.",
      source:
        "https://www.cisco.com/c/en/us/solutions/enterprise-networks/what-is-network-security.html",
      image: networkingImg,
      color: "from-blue-500 to-blue-300",
    },
    {
      name: "Linux",
      description: "Primary OS for security professionals",
      guidance:
        "You'll use Linux extensively for security tools and servers. Become proficient in command line, bash scripting, and system hardening techniques for secure environments.",
    ...
    {
      name: "Encryption",
      description: "Core of data protection",
      guidance:
        "You'll implement cryptographic techniques to secure data in transit and at rest. Study symmetric/asymmetric encryption, hashing algorithms, and PKI infrastructure.",
    ...
    },
    {
      ...
      guidance:
        "You'll learn penetration testing methodologies to identify vulnerabilities. Get familiar with tools like Metasploit, Burp Suite, and Wireshark for security assessments.",
      source: "https://www.eccouncil.org/what-is-ethical-hacking/",
      image: hackingImg,
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="mt-6 text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Master these core technologies to build secure and resilient systems
          </p>
        </div>
