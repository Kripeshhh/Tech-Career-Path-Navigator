...
import wireframingImg from "../images/wiref.png";
import colorTheoryImg from "../images/color.jpg";
import responsiveDesignImg from "../images/responsive.webp";
  ...
  const tools = [
    {
      ...
      guidance:
        "You'll use Figma for creating interfaces, prototypes, and design systems. Master components, auto-layout, and prototyping features for efficient collaborative design workflows.",
    ...
    {
      name: "Wireframing",
      description: "Blueprint of user interfaces",
      guidance:
        "You'll create wireframes to establish information hierarchy and user flows before visual design. Focus on clarity, simplicity, and user needs during this structural phase.",
      source: "https://www.nngroup.com/articles/wireframing/",
      image: wireframingImg,
      color: "from-blue-500 to-blue-300",
    },
    {
      name: "Color Theory",
      description: "Science of visual perception",
      guidance:
        "You'll apply color psychology, contrast ratios, and accessibility standards to create effective palettes. Understand HSL/HSV models and harmonious color combinations.",
      source:
        "https://www.smashingmagazine.com/2010/01/color-theory-for-designers-part-1-the-meaning-of-color/",
      image: colorTheoryImg,
    ...
    },
    {
      ...
      guidance:
        "You'll design flexible systems that work across screen sizes using fluid grids, flexible images, and media queries. Consider mobile-first approaches for modern web projects.",
      source:
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="mt-6 text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Master these core design principles and tools to create stunning,
                ...
                <div className="flex flex-col md:flex-row gap-8 items-start relative z-10">
                  ...
                  <div className="w-full md:w-48 flex-shrink-0 flex justify-center">
                    <div
                      ...
                      shadow-[0_0_20px_rgba(255,192,203,0.5)]
                      transition-shadow duration-300
                      group-hover:shadow-[0_0_30px_rgba(255,192,203,0.8)]
                    `}
                    >
                      <img
                        src={image}
