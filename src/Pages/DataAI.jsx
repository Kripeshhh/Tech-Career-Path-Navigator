...
import tfImage from "./../images/tensor.png";
  ...
  const tools = [
    {
      ...
      guidance:
        "Python is fundamental in Data & AI for scripting, data analysis, and building machine learning models. Its rich ecosystem makes it ideal for rapid prototyping and deploying AI solutions.",
    ...
    },
    {
      ...
      guidance:
        "SQL is essential for querying, managing, and organizing large datasets. Mastering SQL enables efficient data retrieval and preparation, a critical step in any data science workflow.",
    ...
    },
    {
      ...
      description: "Techniques for data-driven predictive modeling",
      guidance:
        "Understanding machine learning algorithms and concepts is key to building intelligent systems. Focus on supervised, unsupervised learning, and model evaluation to develop effective AI models.",
    ...
    },
    {
      ...
      guidance:
        "TensorFlow allows you to design, train, and deploy deep learning models. Learning this tool will help you build scalable AI applications with neural networks and other advanced architectures.",
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="mt-6 text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Master these core technologies to analyze data and build intelligent
            systems
          </p>
        </div>
